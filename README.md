...
<!-- Contenedor principal para organizar en filas -->
<div style="display: flex; flex-wrap: wrap; gap: 20px; background-color: #2C3E50; padding: 20px; border-radius: 8px;">

    <!-- Lenguajes -->
    <div style="flex: 1; background-color: #34495E; padding: 10px; border-radius: 8px;">
    ...
    <!-- Bases de datos -->
    <div style="flex: 1; background-color: #34495E; padding: 10px; border-radius: 8px;">
        <h4 style="color: white;">Databases</h4>
        <p align="left">
